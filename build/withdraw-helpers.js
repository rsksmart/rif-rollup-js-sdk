...
wallet_1.Wallet.prototype.withdrawPendingBalance = function (from, token, amount) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const withdrawAmount = amount ? amount : yield rifRollupContract.getPendingBalance(from, tokenAddress);
...
wallet_1.Wallet.prototype.withdrawPendingBalances = function (addresses, tokens, multicallParams, amounts) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!amounts) {
            const pendingWithdrawalsPromises = addresses.map((address, i) => rifRollupContract.getPendingBalance(address, tokensAddresses[i]));
